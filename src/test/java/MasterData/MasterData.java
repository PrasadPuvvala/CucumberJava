...
public class MasterData extends AbstractWebDriver implements TestInterface {
	...
	public void cm_is_on_main_page() throws InterruptedException {
		...
		try {
			...
			text1 = "Releases tab is clicked";
			text2 = "Releases tab is clicked";
			...
			text1 = "Exception is handled-bypassing OTP screen";
			text2 = "Exception is handled-bypassing OTP screen";
	...
	public void click_on_submit() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*/div[@class='mat-form-field-infix']/input[@placeholder=\"Release Name* \"]"))
				.sendKeys("Rubneium");
		Thread.sleep(2000);

		driver.findElement(
				By.xpath("//*/div[@class='mat-form-field-infix']/input[@placeholder=\"Product Version Name* \"]"))
				.sendKeys("12.0");
		Thread.sleep(2000);
		...
		// Select PDM Engineer
		driver.findElement(By.xpath("//*[@id='mat-tab-content-0-0']/div/mat-form-field[3]/div/div[1]/div/input"))
				.sendKeys(Keys.TAB);
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//*[@id='mat-tab-content-0-0']/div/mat-form-field[4]/div/div[1]/div/input"))
				.sendKeys(Keys.TAB);
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//*[@id='mat-tab-content-0-0']/div/mat-form-field[5]/div/div[1]/div/input"))
				.sendKeys(Keys.TAB);

		driver.findElement(By.xpath("//*/button[@aria-label=\"Open calendar\"]")).click();
		Thread.sleep(4000);
		driver.findElement(By.xpath("//*[@id=\"mat-datepicker-0\"]/div/mat-month-view/table/tbody/tr[5]/td[4]/div"))
				.click();

		// Select End Date from Calender

		driver.findElement(By.xpath(
				"//*[@id=\"mat-tab-content-0-0\"]/div/mat-form-field[7]/div/div[1]/div[2]/mat-datepicker-toggle/button"))
				.click();
		...
		driver.findElement(By.xpath("//*[@id=\"mat-datepicker-1\"]/div/mat-month-view/table/tbody/tr[5]/td[4]/div"))
				.click();

		// Select release date

		driver.findElement(By.xpath(
				"//*[@id=\"mat-tab-content-0-0\"]/div/mat-form-field[8]/div/div[1]/div[2]/mat-datepicker-toggle/button"))
				.click();
		...
		driver.findElement(By.xpath("//*[@id=\"mat-datepicker-2\"]/div/mat-month-view/table/tbody/tr[5]/td[4]/div"))
				.click();
...
//		driver.findElement(By.xpath("//*/div/input[@id='mat-input-0']")).sendKeys("Rubneium");
		...
		Thread.sleep(4000);
		driver.findElement(
				By.xpath("//*[@id=\"mainApp\"]/app-programs-list/div[2]/div/table/tbody/tr/td[10]/button[2]")).click();

		// wait to let the container modal box be visible
		WebDriverWait wait = new WebDriverWait(driver, 30);
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//*[@id='mat-dialog-0']/app-confirmation-dialog/div[1]/div")));

		// to fetch the web element of the modal container
		System.out.println("Fetching the web element for modal container");
		WebElement modalContainer = driver
				.findElement(By.xpath("//*[@id='mat-dialog-0']/app-confirmation-dialog/div[1]/div"));
		...
		Assert.assertEquals("PASS", "Are you sure you want to delete this release Rubneium ?",
				modalContainer.getText());
		...
		WebElement modalContentBody = modalContainer
				.findElement(By.xpath("//*[@class='submit-popup-btn mat-raised-button']"));
	...
	public void driverClose() throws InterruptedException {
		...
		text1 = "after exit in MasterData";
		text2 = "after exit in MasterData";
		ExtentCucumberAdapter
				.addTestStepLog("Comparison in driverClose Passed: " + "Actual: " + text1 + "// Expected: " + text2);
	...
	public void draw() {
		...
		ExtentCucumberAdapter.addTestStepLog("+++Interface Method draw()+++");
	...
	public void loginCheck() {
		...
		ExtentCucumberAdapter.addTestStepLog("+++Interface Method loginCheck()+++");
